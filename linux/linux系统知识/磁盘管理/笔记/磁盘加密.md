...
___ps :对于密钥的操作可以看一下这个链接: https://www.thegeekstuff.com/2016/03/cryptsetup-lukskey/___
...
- 交互式
	通过命令行输入
![[Pasted image 20220413100750.png]]

- 口令文件
	目前未实验成功，根据手册看是可以的，之后再补充
...
#### key描述
可以设置key的描述信息
![[Pasted image 20220413133359.png]]
设置方式
```
...
![[Pasted image 20220413153950.png]]
